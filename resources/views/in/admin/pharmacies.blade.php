            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-info">{{ $pharmacy->users_count }} users</span>
                            <br>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="#" class="btn btn-outline-info" title="Staff">
                                    <i class="bi bi-people"></i>
                                </a>
                                <button class="btn btn-outline-{{ $pharmacy->is_active ? 'warning' : 'success' }}" 
                                        title="{{ $pharmacy->is_active ? 'Deactivate' : 'Activate' }}">
                                    <i class="bi bi-{{ $pharmacy->is_active ? 'x-circle' : 'check-circle' }}"></i>
                                </button>
                            </div>
                        </td>
                    </tr>
